...
folds_std         <- readRDS(here(paths$cv, "folds_std.rds"))
folds_global      <- readRDS(here(paths$cv, "folds_global.rds"))
folds_spatial     <- readRDS(here(paths$cv, "folds_spatial.rds"))
folds_spatial_upz <- readRDS(here(paths$cv, "folds_spatial_upz.rds"))
folds_norte       <- readRDS(here(paths$cv, "folds_norte.rds"))
...
message("======================================================")
message("00_analysis.R COMPLETADO")
message("======================================================")
